...
const plans = [
  {
    name: "Starter",
    description: "Perfect for small teams getting started with drawing and project management",
    price: 29,
    yearlyPrice: 299,
    ...
    includes: [
      ...
      "Up to 10 users",
      "Bids & Projects",
      "Drawings & Revisions (up to 100)",
      "Tickets & Tasks",
      "Basic timesheets",
      "Email support",
      "Standard audit logs (30 days)",
    ],
  },
  {
    name: "Professional",
    description: "Best for growing engineering teams that need advanced workflow controls",
    price: 79,
    yearlyPrice: 799,
    buttonText: "Start free trial",
  ...
  {
    name: "Enterprise",
    description: "For large organizations requiring maximum security, compliance, and customization",
    price: 199,
    yearlyPrice: 1999,
  ...
  return (
    <div className=" min-h-screen  mx-auto relative bg-black overflow-x-hidden" ref={pricingRef}>
      ...
      <article className="text-center mb-6 pt-32 max-w-3xl mx-auto space-y-2 relative z-50">
        ...
        >
          Transparent pricing for engineering teams of all sizes. Start with a 14-day free trial, no credit card required.
        </TimelineContent>
