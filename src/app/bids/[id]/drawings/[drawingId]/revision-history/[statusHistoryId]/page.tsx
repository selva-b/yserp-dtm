...
export default function BidRevisionHistoryDetailPage() {
  ...
  console.log("statusHistory", statusHistory, isMajorVersion, isInitialVersion, isInitialVersionSeries);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm text-gray-500">
            <li>
              <a href="/bids" className="hover:text-blue-600">Bids</a>
            </li>
            <li>/</li>
            <li>
              <a href={`/bids/${bidId}`} className="hover:text-blue-600">Bid Details</a>
            </li>
            <li>/</li>
            <li>
              <a href={`/bids/${bidId}/drawings/${drawingId}`} className="hover:text-blue-600">
        ...
        <div className="mb-6">
          <button
            onClick={() => router.push(`/bids/${bidId}/drawings/${drawingId}`)}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                {fromStatus ? 'Version' : 'Revision Version'}
              </label>
